...
// 数据源类型映射到中文
export const DATA_SOURCE_TYPE_MAP: Record<DataSourceType, string> = {
  academic: '教务系统',
  personnel: '人事系统',
  research: '科研系统',
  student: '学工系统',
...
// 数据库类型映射到中文
export const DATABASE_TYPE_MAP: Record<DatabaseType, string> = {
  mysql: 'MySQL',
  oracle: 'Oracle',
  sqlserver: 'SQLServer',
...
export type DataSourceStatus = 0 | 1 | '0' | '1';
